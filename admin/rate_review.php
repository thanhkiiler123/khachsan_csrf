        ...
        <div class="card border-0 shadow-sm mb-4">
          <div class="card-body">
            ...
            <div class="text-end mb-4">
              ...
              <form id="delete_all" method="post">
                <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token'] ?? '' ?>">
                <button type="submit" class="btn btn-danger rounded-pill shadow-none btn-sm">
                ...
                <tbody>
                  ...
                  while ($row = mysqli_fetch_assoc($data)) {
                    ...
                    $seen .= "
                      <form id='delete_all' method='post'>
                        <input type='hidden' name='csrf_token' value='<?php echo $_SESSION[csrf_token] ?? '' ?>'>
                        <input type='hidden' name='del' value='<?php echo $row[sr_no] ?>'
                        <button type='submit' class='btn btn-sm rounded-pill btn-danger'>
                          Xóa
                        </button>
                      </form>
                    <a href='?del=$row[sr_no]' class='btn btn-sm rounded-pill btn-danger'>Xoá</a>";
